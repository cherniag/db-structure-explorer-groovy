...
public class AppPropertyPlaceholderConfigurerIT {
    ...
    public static String[][] filePaths = {
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/autotest/conf/application.properties", "classpath:n/autotest/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/cherry/conf/application.properties", "classpath:n/cherry/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/cucumber/conf/application.properties", "classpath:n/cucumber/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/potato/conf/application.properties", "classpath:n/potato/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/kiwi/conf/application.properties", "classpath:n/kiwi/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/lime/conf/application.properties", "classpath:n/lime/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/orange/conf/application.properties", "classpath:n/orange/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/rage/conf/application.properties", "classpath:n/rage/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/staging/conf/application.properties", "classpath:n/staging/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/prod_db1/conf/application.properties", "classpath:n/prod_db1/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/prod_db2/conf/application.properties", "classpath:n/prod_db2/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/prod_jadmin/conf/application.properties", "classpath:n/prod_jadmin/conf/application.properties"},
        {"classpath:application.properties", "classpath:n/application.properties", "classpath:props/prod_trackrepo/conf/application.properties", "classpath:n/prod_trackrepo/conf/application.properties"},
