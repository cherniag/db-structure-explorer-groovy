...
@XmlSeeAlso({uk.co.o2.soa.coredata.ObjectFactory.class, uk.co.o2.soa.subscriberdata.ObjectFactory.class})
public interface SubscriberPort {
    ...
    public uk.co.o2.soa.subscriberdata.SubscriberProfileType getSubscriberProfile(@WebParam(name = "subscriberID", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String subscriberID)
    ...
    public SegmentType getSubscriberSegment(@WebParam(name = "SubscriberID", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String subscriberID) throws GetSubscriberSegmentFault;
    ...
    @ResponseWrapper(localName = "getSubscriberPaymentCategoryResponse", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2",
                     className = "uk.co.o2.soa.subscriberdata.GetSubscriberPaymentCategoryResponse")
    public PaymentCategoryType getSubscriberPaymentCategory(@WebParam(name = "SubscriberID", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String subscriberID)
    ...
    public String getSubscriberOperator(@WebParam(name = "SubscriberID", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String subscriberID) throws GetSubscriberOperatorFault;
    ...
    public String getSubscriberChannel(@WebParam(name = "SubscriberID", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String subscriberID) throws GetSubscriberChannelFault;
    ...
    public BillingProfileType getBillingSystem(@WebParam(name = "msisdn", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String msisdn) throws GetBillingSystemFault;
    ...
    @ResponseWrapper(localName = "getSubscriberAndBillingSystemResponse", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2",
                     className = "uk.co.o2.soa.subscriberdata.GetSubscriberAndBillingSystemResponse")
    public void getSubscriberAndBillingSystem(@WebParam(name = "msisdn", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String msisdn,
    ...
    public void getBillProfile(@WebParam(name = "msisdn", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String msisdn,
                               @WebParam(name = "accountNumber", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2", mode = WebParam.Mode.INOUT) Holder<String> accountNumber,
                               @WebParam(name = "billingSystem", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2", mode = WebParam.Mode.OUT) Holder<BillingProfileType> billingSystem,
                               @WebParam(name = "msisdnList", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2", mode = WebParam.Mode.OUT) Holder<MsisdnList> msisdnList)
    ...
    public List<String> getChargingCategory(@WebParam(name = "msisdn", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String msisdn,
                                            @WebParam(name = "productList", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") ProductListType productList) throws GetChargingCategoryFault;
    ...
    public ServiceProviderDetailsType getSPIDDetails1(@WebParam(name = "serviceProviderId", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2") String serviceProviderId)
