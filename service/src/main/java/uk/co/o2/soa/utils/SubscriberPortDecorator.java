...
import uk.co.o2.soa.subscriberservice.GetBillProfileFault;
import uk.co.o2.soa.subscriberservice.GetBillingSystemFault;
import uk.co.o2.soa.subscriberservice.GetChargingCategoryFault;
import uk.co.o2.soa.subscriberservice.GetSPIDDetails1Fault;
import uk.co.o2.soa.subscriberservice.GetSubscriberAndBillingSystemFault;
import uk.co.o2.soa.subscriberservice.GetSubscriberChannelFault;
import uk.co.o2.soa.subscriberservice.GetSubscriberOperatorFault;
import uk.co.o2.soa.subscriberservice.GetSubscriberPaymentCategoryFault;
import uk.co.o2.soa.subscriberservice.GetSubscriberProfileFault;
import uk.co.o2.soa.subscriberservice.GetSubscriberSegmentFault;
import uk.co.o2.soa.subscriberservice.SubscriberPort;
