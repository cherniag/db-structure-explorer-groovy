...
public interface SubscriberPort {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "getBillProfile", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2", className = "uk.co.o2.soa.subscriberdata_2.GetBillProfile")
    @ResponseWrapper(localName = "getBillProfileResponse", targetNamespace = "http://soa.o2.co.uk/subscriberdata_2", className = "uk.co.o2.soa.subscriberdata_2.GetBillProfileResponse")
