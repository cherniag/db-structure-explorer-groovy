...
/**
 * Methods of this class are intercepted by AOP and used to send sms messages. The methods are not in UserService because AOP can't intercept calls in the same object
 */
