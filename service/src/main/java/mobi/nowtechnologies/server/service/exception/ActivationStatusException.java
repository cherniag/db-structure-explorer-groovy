...
public class ActivationStatusException extends ServiceException {
    ...
    public ActivationStatusException(ActivationStatus curActivationStatus,ActivationStatus mustActivationStatus) {
        super("604", "User activation status ["+curActivationStatus+"] is invalid. User must have status ["+mustActivationStatus+"]", "error.604.activation.status."+curActivationStatus+".must."+mustActivationStatus);
    }
