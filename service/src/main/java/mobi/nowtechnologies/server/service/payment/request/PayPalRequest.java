...
public class PayPalRequest extends AbstractPaymentRequest<PayPalRequest> {
    ...
    public PayPalRequest createTokenRequest(String billingAgreementDescription, String successUrl, String failUrl, String currencyCode, String communityRewriteUrlParameter) {
        return createDefaultRequest(communityRewriteUrlParameter).addParam(PayPalRequestParam.RETURNURL, successUrl != null ?
                                                                                                         successUrl :
                                                                                                         getValueOf(communityRewriteUrlParameter, RETURN_URL)).addParam(PayPalRequestParam.CANCELURL,
                                                                                                                                                                        failUrl != null ?
                                                                                                                                                                        failUrl :
                                                                                                                                                                        getValueOf(
                                                                 ...
                                                                 .addParam(PayPalRequestParam.CURRENCYCODE, currencyCode).addParam(PayPalRequestParam.METHOD, METHOD_SET_EXPRESS_CHECKOUT)
