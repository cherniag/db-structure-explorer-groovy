...
public class MigRequest extends AbstractPaymentRequest<MigRequest> {
	...
	public MigRequest createFreeSMSRequest(String numbers, String message) {
		return new MigRequest()
			.addParam(MigRequestParam.OADC, OADC_FREE)
	...
	public MigRequest createPremiumSMSRequest(String messageId, String oadc, String numbers, String message, String timeToLive) {
		return new MigRequest()
			...
			.addParam(MigRequestParam.OADCTYPE, OADCTYPE_PREMIUM)
			.addParam(MigRequestParam.MESSAGEID, messageId)
			.addParam(MigRequestParam.NUMBERS, numbers)
			.addParam(MigRequestParam.BODY, message)
			.addParam(MigRequestParam.TIMETOLIVE, timeToLive);
	}
}