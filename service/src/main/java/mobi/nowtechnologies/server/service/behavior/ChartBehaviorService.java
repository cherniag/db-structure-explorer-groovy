...
public class ChartBehaviorService {
    ...
    public Map<Integer, Collection<ChartBehaviorInfo>> info(BehaviorConfig behaviorConfig,
                                                      List<Pair<UserStatusType, Date>> userStatusTypeDateMap,
                                                      UserReferralsSnapshot snapshot, User user, Date serverTime) {
