...
public class DeepLinkUrlFactoryTest {
    ...
    public void checkCreateLinkValueForInformationAppPage() throws Exception {
        ...
        //check
        String o = deepLinkUrlFactory.create(informationDeeplinkInfo, "hl_uk", null);
    ...
    public void checkCreateLinkValueForInformationAppPageWithAction() throws Exception {
        ...
        //check
        Object o = deepLinkUrlFactory.create(informationDeeplinkInfo, "hl_uk", null);
    ...
    public void checkCreateLinkValueForInformationWebPage() throws Exception {
        ...
        //check
        Object o = deepLinkUrlFactory.create(informationDeeplinkInfo, "o2", null);
    ...
    public void checkCreateLinkValueForMusicTrack() throws Exception {
        ...
        //check
        Object o = deepLinkUrlFactory.create(musicTrackDeeplinkInfo, "hl_uk", null);
    ...
    public void checkCreateLinkValueForMusicPlayList() throws Exception {
        ...
        //check
        String o = deepLinkUrlFactory.create(musicPlayListDeeplinkInfo, "hl_uk", null);
    ...
    public void checkCreateLinkValueForNewsStory() throws Exception {
        ...
        //check
        String o = deepLinkUrlFactory.create(newsStoryDeeplinkInfo, "hl_uk", null);
    ...
    public void checkCreateLinkValueForNewsList() throws Exception {
        ...
        //check
        String o = deepLinkUrlFactory.create(newsListDeeplinkInfo, "hl-uk", null);
