...
//	}
    ...
    public void shouldReturnCanPlayVideoTrueForUserOn4GVideoAudioFreeTrial(){
        ...
        //when
        boolean canPlayVideo = userServiceSpy.canPlayVideo(user);

        //then
        assertEquals(true, canPlayVideo);
    }
    ...
    public void shouldReturnCanPlayVideoFalseForUserWith4GVideoAudioFreeTrialExpiredAndNotOnBoughtVideoAudioPeriod(){
        ...
        //then
        assertEquals(false, canPlayVideo);
    }
    ...
    public void shouldNotMightActivateVideoTrialForO2Paym4GIndirectConsumerWithVideoAudioFreeTrialHasBeenActivated(){
        ...
        Mockito.when(communityResourceBundleMessageSourceMock.readDate(UserService.MULTIPLE_FREE_TRIAL_STOP_DATE, newDate(1, 1, 2014))).thenReturn(multipleFreeTrialsStopDate);
