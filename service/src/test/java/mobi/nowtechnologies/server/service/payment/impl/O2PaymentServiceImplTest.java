...
@PrepareForTest({UserService.class, UserStatusDao.class, Utils.class, DeviceTypeDao.class, UserGroupDao.class, AccountLog.class, SubmittedPayment.class, O2PSMSPaymentDetails.class})
