...
public class ITunesServiceImplTest {
    ...
    public static final UserStatus LIMITED_USER_STATUS = UserStatusFactory.createUserStatus(mobi.nowtechnologies.server.shared.enums.UserStatus.LIMITED);
    public static final UserStatus SUBSCRIBED_USER_STATUS = UserStatusFactory.createUserStatus(mobi.nowtechnologies.server.shared.enums.UserStatus.SUBSCRIBED);
	...
	public void testProcessInAppSubscription_WithoutPaymentDetails_Success()
		...
		Mockito.when(mockUserService.findById(user.getId())).thenReturn(user);
        ...
        BasicResponse actualResponse = fixtureITunesServiceImpl.processInAppSubscription(user.getId(), base64EncodedAppStoreReceipt);

		assertNotNull(actualResponse);
		assertEquals(expectedResponse, actualResponse);

		Mockito.verify(mockUserService, Mockito.times(1)).findById(user.getId());
    ...
    @SuppressWarnings("unchecked")
	@Test
	public void checkInAppSubscriptionWithArrayOfLastReceiptInfo()
		throws Exception {
		final String base64EncodedAppStoreReceipt = "";
		final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
		final String originalTransactionId = "1000000064861007";
	...
	public void checkInAppResponseWithEmptyLastReceiptInfo() throws Exception {
		final String base64EncodedAppStoreReceipt = "";
		final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
		final String originalTransactionId = "1000000064861007";
		final long expiresDate = 1360756242000L;
        ...
        BasicResponse expectedResponse = new BasicResponse();
		expectedResponse.setStatusCode(200);
		expectedResponse.setMessage("{ \"receipt\" : { \"original_purchase_date_pst\" : \"2013-02-13 03:41:43 America/Los_Angeles\", \"unique_identifier\" : \"80d70017aae1547196bc92c02c3f83cc5f9e4cc6\", \"original_transaction_id\" : \"" + originalTransactionId + "\", \"expires_date\" : \"" + expiresDate + "\", \"transaction_id\" : \"" + appStoreOriginalTransactionId + "\", \"quantity\" : \"1\", \"product_id\" : \"" + appStoreProductId + "\", \"original_purchase_date_ms\" : \"1360755703334\", \"bid\" : \"com.musicqubed.o2\", \"web_order_line_item_id\" : \"1000000026638439\", \"bvrs\" : \"1.0\", \"expires_date_formatted\" : \"2013-02-13 11:44:42 Etc/GMT\", \"purchase_date\" : \"2013-02-13 11:41:42 Etc/GMT\", \"purchase_date_ms\" : \"1360755702795\", \"expires_date_formatted_pst\" : \"2013-02-13 03:44:42 America/Los_Angeles\", \"purchase_date_pst\" : \"2013-02-13 03:41:42 America/Los_Angeles\", \"original_purchase_date\" : \"2013-02-13 11:41:43 Etc/GMT\", \"item_id\" : \"602725828\" }, \"latest_receipt_info\" : [], \"status\" : 0, \"latest_receipt\" : \"" + transactionReceipt + "\" }");
        Mockito.when(mockUserService.findById(user.getId())).thenReturn(user);
		Mockito.when(mockPostService.sendHttpPost(Mockito.eq(iTunesUrl), (List<NameValuePair>) Mockito.isNull(), Mockito.eq(body))).thenReturn(expectedResponse);
        fixtureITunesServiceImpl.processInAppSubscription(user.getId(), base64EncodedAppStoreReceipt);
	}

    @SuppressWarnings("unchecked")
    @Test(expected = IllegalArgumentException.class)
    public void checkInAppResponseWith2LastReceiptInfo() throws Exception {
        final String base64EncodedAppStoreReceipt = "";
        final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
        final String originalTransactionId = "1000000064861007";
        final long expiresDate = 1360756242000L;
        ...
        BasicResponse expectedResponse = new BasicResponse();
        expectedResponse.setStatusCode(200);
        expectedResponse.setMessage("{ \"receipt\" : { \"original_purchase_date_pst\" : \"2013-02-13 03:41:43 America/Los_Angeles\", \"unique_identifier\" : \"80d70017aae1547196bc92c02c3f83cc5f9e4cc6\", \"original_transaction_id\" : \"" + originalTransactionId + "\", \"expires_date\" : \"" + expiresDate + "\", \"transaction_id\" : \"" + appStoreOriginalTransactionId + "\", \"quantity\" : \"1\", \"product_id\" : \"" + appStoreProductId + "\", \"original_purchase_date_ms\" : \"1360755703334\", \"bid\" : \"com.musicqubed.o2\", \"web_order_line_item_id\" : \"1000000026638439\", \"bvrs\" : \"1.0\", \"expires_date_formatted\" : \"2013-02-13 11:44:42 Etc/GMT\", \"purchase_date\" : \"2013-02-13 11:41:42 Etc/GMT\", \"purchase_date_ms\" : \"1360755702795\", \"expires_date_formatted_pst\" : \"2013-02-13 03:44:42 America/Los_Angeles\", \"purchase_date_pst\" : \"2013-02-13 03:41:42 America/Los_Angeles\", \"original_purchase_date\" : \"2013-02-13 11:41:43 Etc/GMT\", \"item_id\" : \"602725828\" }, \"latest_receipt_info\" : [{\"original_transaction_id\" : \"" + originalTransactionId + "\"},{\"original_transaction_id\" : \"" + originalTransactionId + "\"}], \"status\" : 0, \"latest_receipt\" : \"" + transactionReceipt + "\" }");
        Mockito.when(mockUserService.findById(user.getId())).thenReturn(user);
        Mockito.when(mockPostService.sendHttpPost(Mockito.eq(iTunesUrl), (List<NameValuePair>)Mockito.isNull(), Mockito.eq(body))).thenReturn(expectedResponse);
        fixtureITunesServiceImpl.processInAppSubscription(user.getId(), base64EncodedAppStoreReceipt);
    }
    ...
    @SuppressWarnings("unchecked")
    @Test(expected = IllegalArgumentException.class)
    public void checkInAppResponseWithoutLastReceiptInfo() throws Exception {
        final String base64EncodedAppStoreReceipt = "";
        final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
        final String originalTransactionId = "1000000064861007";
        final long expiresDate = 1360756242000L;
        ...
        BasicResponse expectedResponse = new BasicResponse();
        expectedResponse.setStatusCode(200);
        expectedResponse.setMessage("{ \"receipt\" : { \"original_purchase_date_pst\" : \"2013-02-13 03:41:43 America/Los_Angeles\", \"unique_identifier\" : \"80d70017aae1547196bc92c02c3f83cc5f9e4cc6\", \"original_transaction_id\" : \"" + originalTransactionId + "\", \"expires_date\" : \"" + expiresDate + "\", \"transaction_id\" : \"" + appStoreOriginalTransactionId + "\", \"quantity\" : \"1\", \"product_id\" : \"" + appStoreProductId + "\", \"original_purchase_date_ms\" : \"1360755703334\", \"bid\" : \"com.musicqubed.o2\", \"web_order_line_item_id\" : \"1000000026638439\", \"bvrs\" : \"1.0\", \"expires_date_formatted\" : \"2013-02-13 11:44:42 Etc/GMT\", \"purchase_date\" : \"2013-02-13 11:41:42 Etc/GMT\", \"purchase_date_ms\" : \"1360755702795\", \"expires_date_formatted_pst\" : \"2013-02-13 03:44:42 America/Los_Angeles\", \"purchase_date_pst\" : \"2013-02-13 03:41:42 America/Los_Angeles\", \"original_purchase_date\" : \"2013-02-13 11:41:43 Etc/GMT\", \"item_id\" : \"602725828\" }, \"status\" : 0, \"latest_receipt\" : \"" + transactionReceipt + "\" }");
        Mockito.when(mockUserService.findById(user.getId())).thenReturn(user);
        Mockito.when(mockPostService.sendHttpPost(Mockito.eq(iTunesUrl), (List<NameValuePair>)Mockito.isNull(), Mockito.eq(body))).thenReturn(expectedResponse);
        fixtureITunesServiceImpl.processInAppSubscription(user.getId(), base64EncodedAppStoreReceipt);
    }
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testProcessInAppSubscription_WithDeactivatedPaymentDetails_Success() throws Exception {
		final String base64EncodedAppStoreReceipt = "";
		final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
		final String originalTransactionId = "1000000064861007";
		final long expiresDate = 1360756242000L;
    ...
    private void createUser() {
        community = CommunityFactory.createCommunity();
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testProcessInAppSubscription_WithoutPaymentDetailsWhenUserInLIMITEDAndHasBase64EncodedAppStoreReceipt_Success()	throws Exception {
		final String base64EncodedAppStoreReceipt = "";
		final String transactionReceipt = base64EncodedAppStoreReceipt.replaceAll("=", "\\\\u003d");
		final String originalTransactionId = "1000000064861007";
		final long expiresDate = 1360756242000L;
