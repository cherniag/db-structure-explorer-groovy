...
public class VersionCheckServiceIT {
    ...
    public void testVersionForO2CommunityWhereRangesArePresent() {
        ...
        checkVersion(null, 0, 0, 1, VersionCheckStatus.REVOKED, "VERSION_REJECTED", "http://play.google.com/new_community_app", O2_TRACKS_APPLICATION_NAME);
        checkVersion(null, 1, 0, 0, VersionCheckStatus.REVOKED, "VERSION_REJECTED", "http://play.google.com/new_community_app", O2_TRACKS_APPLICATION_NAME);
        ...
        checkVersion(null, 1, 7, 1, VersionCheckStatus.CURRENT, null, null, O2_TRACKS_APPLICATION_NAME);
        checkVersion(null, 2, 0, 1, VersionCheckStatus.CURRENT, null, null, O2_TRACKS_APPLICATION_NAME);
    }
    ...
    public void testVersionForO2CommunityWhereRangesArePresentForQualifier() {
        community = CommunityDao.getCommunity("o2");
        deviceType = DeviceTypeDao.getAndroidDeviceType();
        checkVersion("RELEASE", 1, 5, 0, VersionCheckStatus.REVOKED, "VERSION_REJECTED", "http://play.google.com/new_community_app", O2_TRACKS_APPLICATION_NAME_WQ);
    }
    ...
    public void testVersionForHLUKCommunityWhereNoConfigurationAtAll() {
        ...
        deviceType = DeviceTypeDao.getAndroidDeviceType();
        checkVersion(null, 1, 4, 0, VersionCheckStatus.CURRENT, null, null, HL_UK_APPLICATION_NAME);
        checkVersion(null, 1, 7, 1, VersionCheckStatus.CURRENT, null, null, HL_UK_APPLICATION_NAME);
    }

    private void checkVersion(String qualifier, int major, int minor, int revision, VersionCheckStatus status, String messageKey, String url, String applicationName){
