...
public class SMSNotificationTest {
	...
	@Test
	public void testGetMessageCode_NotNullProviderSegmentContract_AndBeforeProviderAndNullConsumerAndNullContract_Success()
			throws Exception {
		PaymentPolicy paymentPolicy = PaymentPolicyFactory.createPaymentPolicy();
		paymentPolicy.setProvider("non-o2");
	...
	@Test
	public void testGetMessageCode_NotNullProviderSegmentContract_AndBeforeSameProviderAndNotSameConsumerAndNullContract_Success()
			throws Exception {
		PaymentPolicy paymentPolicy = PaymentPolicyFactory.createPaymentPolicy();
	...
	@Test
	public void testGetMessageCode_NotNullProviderSegmentContract_AndBeforeSameProviderAndSameConsumerAndNotSameContract_Success()
			throws Exception {
		PaymentPolicy paymentPolicy = PaymentPolicyFactory.createPaymentPolicy();
		paymentPolicy.setProvider("o2");
		paymentPolicy.setSegment(SegmentType.CONSUMER);
