...
public class SMSNotificationTest {
	...
	public void testSendLimitedStatusSMS_Success()
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.limited.status.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(Object[].class), eq(""), eq((Locale) null));
	...
	public void testSendLimitedStatusSMS_WithBadTinyServiceUrl_Success()
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.limited.status.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(String[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(1)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
	...
	public void testSendUnsubscribePotentialSMS_Success()
		...
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.unsubscribe.potential.text.for.o2.CONSUMER.PAYG"), any(Object[].class), eq(""), eq((Locale) null)))
				.thenReturn(msg);
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null))).thenReturn(title);
		doReturn(null).when(mockMigService).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.unsubscribe.potential.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(Object[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(1)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
	...
	public void testSendUnsubscribePotentialSMS_WithBadTinyServiceUrl_Success()
		...
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.unsubscribe.potential.text.for.o2.CONSUMER.PAYG"), any(String[].class), eq(""), eq((Locale) null)))
				.thenReturn(msg);
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null))).thenReturn(title);
		doReturn(null).when(mockMigService).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.unsubscribe.potential.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(String[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(1)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
	...
	public void testSendUnsubscribeAfterSMS_Success()
		...
		when(
				mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.unsubscribe.after.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()),
						any(Object[].class), eq(""), eq((Locale) null))).thenReturn(msg);
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null))).thenReturn(title);
		doReturn(null).when(mockMigService).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.unsubscribe.after.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(Object[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(1)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
	...
	public void testSendLowBalanceWarning_EmptyMsg_Failure()
		...
		when(
				mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.lowBalance.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()),
						any(Object[].class), eq(""), eq((Locale) null))).thenReturn(msg);
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null))).thenReturn(title);
		doReturn(null).when(mockMigService).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.lowBalance.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(Object[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(0)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
	...
	public void testSendPaymentFailSMS_EmptyMsg_Failure()
		...
		when(
				mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.paymentFail.at.0h.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()),
						any(Object[].class), eq(""), eq((Locale) null))).thenReturn(msg);
		when(mockMessageSource.getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null))).thenReturn(title);
		doReturn(null).when(mockMigService).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
		...
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()),
				eq("sms.paymentFail.at.0h.text.for." + user.getProvider() + "." + user.getSegment() + "." + user.getContract()), any(Object[].class), eq(""), eq((Locale) null));
		verify(mockMessageSource, times(1)).getMessage(eq(community.getRewriteUrlParameter()), eq("sms.title"), any(Object[].class), eq((Locale) null));
		verify(mockMigService, times(0)).makeFreeSMSRequest(anyString(), eq(msg), eq(title));
	}
