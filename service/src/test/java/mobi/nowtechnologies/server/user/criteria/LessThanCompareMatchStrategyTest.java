...
public class LessThanCompareMatchStrategyTest<T extends Number & Comparable<T>> extends AbstractCompareMatchStrategyTest<T> {
    ...
    public static Collection<Object[]> data() {
        return Lists.newArrayList(new Object[][] {
                                      //byte
                                      {"First param should be less than second for byte", (byte) 1, lessThan(
                                          (byte) 20), true, null}, {"First param should not be less than second for byte", (byte) 10, lessThan(
                                      ...
                                      //short
                                      {"First param should be less than second for short", (short) 5, lessThan(
                                          (short) 20), true, null}, {"First param should not be less than second for short", (short) 25, lessThan(
                                      ...
                                      240), false, null}, {"First param should not be equal to second for int", 55, lessThan(
                                      55), false, null}, {"First param should not be equal to second for int", 0, lessThan(
                                      0), false, null}, {"First param should not be equal to second for int", -55, lessThan(
                                      -55), false, null}, {"First param should be less than second for int", -51, lessThan(
                                      -5), true, null}, {"First param should be less than second for int", -10, lessThan(
                                      0), true, null}, {"First param should be less than second for int", 0, lessThan(
                                      ...
                                      //float
                                      {"First param should be less than second for float", 7.62F, lessThan(
                                          55.45F), true, null}, {"First param should not be less than second for float", 95.45F, lessThan(
                                      ...
                                      //double
                                      {"First param should be less than second for double", 5.45D, lessThan(
                                          5.56D), true, null}, {"First param should not be less than second for double", 7.62D, lessThan(
