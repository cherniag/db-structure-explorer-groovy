...
public class LessOrEqualToCompareMatchStrategyTest<T extends Number & Comparable<T>> extends AbstractCompareMatchStrategyTest<T> {
    ...
    public static Collection<Object[]> data() {
        return Lists.newArrayList(new Object[][] {
                                      //byte
                                      {"First param should be less than second for byte", (byte) 1, lessOrEqualTo(
                                          (byte) 20), true, null}, {"First param should not be less than second for byte", (byte) 10, lessOrEqualTo(
                                      ...
                                      //short
                                      {"First param should be less than second for short", (short) 5, lessOrEqualTo(
                                          (short) 20), true, null}, {"First param should not be less than second for short", (short) 25, lessOrEqualTo(
                                      ...
                                      240), false, null}, {"First param should be equal to second for int", 55, lessOrEqualTo(
                                      55), true, null}, {"First param should be equal to second for int", 0, lessOrEqualTo(
                                      0), true, null}, {"First param should be equal to second for int", -55, lessOrEqualTo(
                                      -55), true, null}, {"First param should be less than second for int", -51, lessOrEqualTo(
                                      -5), true, null}, {"First param should be less than second for int", -10, lessOrEqualTo(
                                      0), true, null}, {"First param should be less than second for int", 0, lessOrEqualTo(
                                      ...
                                      //long
                                      {"First param should be less than second for long", 1000L, lessOrEqualTo(
                                          2999L), true, null}, {"First param should not be less than second for long", 1000L, lessOrEqualTo(
                                      ...
                                      //float
                                      {"First param should be less than second for float", 7.62F, lessOrEqualTo(
                                          55.45F), true, null}, {"First param should not be less than second for float", 95.45F, lessOrEqualTo(
                                      ...
                                      //double
                                      {"First param should be less than second for double", 5.45D, lessOrEqualTo(
                                          5.56D), true, null}, {"First param should not be less than second for double", 7.62D, lessOrEqualTo(
