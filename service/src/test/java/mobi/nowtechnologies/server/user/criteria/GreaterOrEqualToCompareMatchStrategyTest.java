...
public class GreaterOrEqualToCompareMatchStrategyTest<T extends Number & Comparable<T>> extends AbstractCompareMatchStrategyTest<T> {
    ...
    public static Collection<Object[]> data() {
        return Lists.newArrayList(new Object[][] {{"First param should be greater than second for byte", (byte) 127, greaterOrEqualTo(
            ...
            //int
            {"First param should be greater than second for int", 10, greaterOrEqualTo(5), true, null}, {"First param should not be greater than second for int", 30, greaterOrEqualTo(
            240), false, null}, {"First param should be equal to second for int", 55, greaterOrEqualTo(55), true, null}, {"First param should be equal to second for int", 0, greaterOrEqualTo(
            0), true, null}, {"First param should be equal to second for int", -55, greaterOrEqualTo(-55), true, null}, {"First param should be equal to second for int", -5, greaterOrEqualTo(
            -5), true, null}, {"First param should be greater than second for int", -1, greaterOrEqualTo(-5), true, null}, {"First param should be greater than second for int", 0, greaterOrEqualTo(
            ...
            //long
            {"First param should be greater than second for long", 1000L, greaterOrEqualTo(999L), true, null}, {"First param should not be greater than second for long", 1000L, greaterOrEqualTo(
            ...
            //float
            {"First param should be greater than second for float", 7.62F, greaterOrEqualTo(5.45F), true, null}, {"First param should not be greater than second for float", 5.45F, greaterOrEqualTo(
            ...
            //double
            {"First param should be greater than second for double", 5.56D, greaterOrEqualTo(5.45D), true, null}, {"First param should not be greater than second for double", 7.62D, greaterOrEqualTo(
            ...
            (Double) null), true, IllegalArgumentException.class}, {"Null can not be compared", null, greaterOrEqualTo((Double) null), true, IllegalArgumentException.class},});
    }
