...
public class GreaterThanCompareMatchStrategyTest<T extends Number & Comparable<T>> extends AbstractCompareMatchStrategyTest<T> {
    ...
    public static Collection<Object[]> data() {
        return Lists.newArrayList(new Object[][] {
            //byte
            {"First param should be greater than second for byte", (byte) 127, greaterThan((byte) 20), true, null}, {"First param should not be greater than second for byte", (byte) 10, greaterThan(
            ...
            240), false, null}, {"First param should not be equal to second for int", 55, greaterThan(55), false, null}, {"First param should not be equal to second for int", 0, greaterThan(
            0), false, null}, {"First param should not be equal to second for int", -55, greaterThan(-55), false, null}, {"First param should be greater than second for int", -1, greaterThan(
            -5), true, null}, {"First param should be greater than second for int", 0, greaterThan(-5), true, null}, {"First param should be greater than second for int", 2, greaterThan(
            ...
            //long
            {"First param should be greater than second for long", 1000L, greaterThan(999L), true, null}, {"First param should not be greater than second for long", 1000L, greaterThan(
            ...
            //float
            {"First param should be greater than second for float", 7.62F, greaterThan(5.45F), true, null}, {"First param should not be greater than second for float", 5.45F, greaterThan(
            ...
            //double
            {"First param should be greater than second for double", 5.56D, greaterThan(5.45D), true, null}, {"First param should not be greater than second for double", 7.62D, greaterThan(
