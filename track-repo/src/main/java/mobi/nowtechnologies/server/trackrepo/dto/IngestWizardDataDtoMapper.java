...
public class IngestWizardDataDtoMapper extends IngestWizardDataDto {
            ...
            for (DropDto dropDto : dropDtos) {
                ...
                if (dropTracks != null) {
                    ...
                    for (DropTrackDto trackDto : dropTracks) {
                        ...
                        track.setType(trackDto.getType() != null ?
                                      DropTrack.Type.valueOf(trackDto.getType().name()) :
                                      null);
    ...
    private DropDto toDrops(DropsData.Drop drop) {
        ...
        List<IngestData.Track> tracks = drop.getIngestdata() != null ?
                                        drop.getIngestdata().getData() :
                                        null;
        if (tracks != null) {
