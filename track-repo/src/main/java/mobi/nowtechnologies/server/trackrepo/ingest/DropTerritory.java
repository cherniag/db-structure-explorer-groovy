...
public class DropTerritory {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("country", country).append("label", label).append("currency", currency).append("price", price).append("startdate", startdate)
                                        .append("reportingId", reportingId).append("distributor", distributor).append("takeDown", takeDown).append("priceCode", priceCode)
                                        .append("dealReference", dealReference).append("publisher", publisher).toString();
    }
}
