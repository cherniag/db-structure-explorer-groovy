...
public class TrackController extends AbstractCommonController{
	...
	public @ResponseBody WebAsyncTask<TrackDto> encode(
            final @PathVariable("trackId")Long trackId,
			final @RequestParam(value="isHighRate", required = false) Boolean isHighRate,
	...
	public @ResponseBody PageListDto<? extends TrackDto> find(
