...
echo "***** Generating Mobile Audio *****"
	...
	java -jar ${CP}/uits-4.0-SNAPSHOT.jar ${PRIVATE_KEY} ${ISRC}_48.m4a ${ISRC}_48.aud ${ISRC}_48.hdr ${ISRC}_48.enc || { echo "command failed"; exit 1; }
	...
	java -jar ${CP}/uits-4.0-SNAPSHOT.jar ${PRIVATE_KEY} ${ISRC}_96.m4a ${ISRC}_96.aud ${ISRC}_96.hdr ${ISRC}_96.enc || { echo "command failed"; exit 1; }
