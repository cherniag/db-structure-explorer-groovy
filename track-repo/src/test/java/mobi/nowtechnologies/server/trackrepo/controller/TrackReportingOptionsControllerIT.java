...
public class TrackReportingOptionsControllerIT extends AbstractTrackRepoIT {
    ...
    public void shouldSaveReportingOptions() throws Exception {
        //given
        Track track1 = trackRepository.save(
            new Track().withNegativeTags(new HashSet<NegativeTag>(asList(new NegativeTag().withTag("d")))).withIngestor("ingestor").withIsrc("isrc").withTitle("title").withArtist("artist")
