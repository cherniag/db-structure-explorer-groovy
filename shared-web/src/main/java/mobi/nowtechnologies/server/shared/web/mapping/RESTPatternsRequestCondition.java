...
public class RESTPatternsRequestCondition extends AbstractRequestCondition<PatternsRequestCondition>{
    ...
    public RESTPatternsRequestCondition(String[] patterns,
    ...
    public PatternsRequestCondition getMatchingCondition(HttpServletRequest request) {
        ...
        return matches.isEmpty() ? null :
                new PatternsRequestCondition(matches.toArray(new String[matches.size()]),
                                                this.urlPathHelper,
                                                this.pathMatcher,
    ...
    protected String getRESTMatchingPattern(String pattern, String lookupPath) {
        if (this.useSuffixPatternMatch) {
            ...
            lastSubpathStart = lastSubpathStart < 0 ? 0 : lastSubpathStart;
