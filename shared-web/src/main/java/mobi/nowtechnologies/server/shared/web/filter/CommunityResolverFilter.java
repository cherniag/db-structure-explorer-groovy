...
/**
 * This filter applies only once per request and assign specific community according to request parameters. Community is searched via repository and set to cookies if it's not there already.
 *
