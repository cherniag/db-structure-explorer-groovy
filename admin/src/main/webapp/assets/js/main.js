...
$(function() {
    ...
    var setPopoverHeight = function (popoverSelector) {
      var this$ = $(popoverSelector);
      var popover$ = popoverSelector.data("popover").$tip;
    ...
    popoverSelector.each(function () {
        ...
        $this.on("shown", function(){
          window[$this.attr("onShownPopover")]($this, setPopoverHeight);
          setPopoverHeight($this);
        });
    ...
    $(".play").mouseover(function(){
        ...
        if(!modalEl.is(':visible')){
               ...
               var videoEl = modalEl.find("video, audio, .media-track");
    ...
    var hideIfNotPlay = function(playArea, playEl, e){
        ...
        var id = $(playEl).find('.media-track').attr('id');
        if (id){
