...
public class BadgesService {
    ...
    public List<FilenameAlias> findAllBadges() {
        return filenameAliasRepository.findAllByDomain(FilenameAlias.Domain.HEY_LIST);
    }
    ...
    public ImageDTO upload(MultipartFile file) {
        ...
        filenameAliasRepository.save(new FilenameAlias(fileNameInCloud, fileNameInCloud).forDomain(FilenameAlias.Domain.HEY_LIST));
