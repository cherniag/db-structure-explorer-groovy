...
public class ErrorController {
    ...
    protected ModelAndView getModelAndView(HttpServletRequest request, String viewName) {
        ...
        modelAndView.addObject("errorCode", code != null ?
                                            code.toString() :
                                            null);
        modelAndView.addObject("errorMessage", message != null ?
                                               message.toString() :
                                               null);
        modelAndView.addObject("exeptionType", type != null ?
                                               type.toString() :
                                               null);
        modelAndView.addObject("requestedUri", uri != null ?
                                               uri.toString() :
                                               null);
