...
public class AdController extends AbstractCommonController {
    ...
    public ModelAndView saveAd(HttpServletRequest request, HttpServletResponse response, @Valid @ModelAttribute(AdItemDto.NAME) AdItemDto adItemDto, BindingResult bindingResult) {
    ...
    public ModelAndView updateAd(HttpServletRequest request, HttpServletResponse response, @Valid @ModelAttribute(AdItemDto.NAME) AdItemDto adItemDto, BindingResult bindingResult) {
