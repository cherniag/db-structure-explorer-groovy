...
public class MessageController extends AbstractMessageController {
    ...
    public ModelAndView saveMessage(HttpServletRequest request, @Valid @ModelAttribute(MessageDto.MESSAGE_DTO) MessageDto messageDto, BindingResult bindingResult) {
    ...
    public ModelAndView updateMessage(HttpServletRequest request, @Valid @ModelAttribute(MessageDto.MESSAGE_DTO) MessageDto messageDto, BindingResult bindingResult) {
