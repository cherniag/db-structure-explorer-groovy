...
public class TrackRepoController extends AbstractCommonController {
    ...
    @Resource
    private CommunityDtoAsm communityDtoAsm;
    ...
    public ModelAndView findTracks(@RequestParam(value = "query", required = false) String query, @ModelAttribute(SEARCH_TRACK_DTO) SearchTrackDto searchTrackDto, BindingResult bindingResult,
    ...
    public
    @ResponseBody
    Callable<String> encodeTrack2(@RequestParam Map<String, String> params) {
