...
public class OfferController extends AbstractCommonController {
    ...
    public ModelAndView saveOffer(HttpServletRequest request, @Valid @ModelAttribute(OfferDto.OFFER_DTO) OfferDto offerDto, BindingResult bindingResult) {
    ...
    public ModelAndView updateOffer(HttpServletRequest request, @Valid @ModelAttribute(OfferDto.OFFER_DTO) OfferDto offerDto, BindingResult bindingResult) {
