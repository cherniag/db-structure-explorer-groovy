...
public class NewsController extends AbstractMessageController {
     ...
     *
     * @param request
     * @param selectedPublishDate - selected date represented in URI
     * @return
     */
     ...
     *
     * @param request
     * @param newsPositionsDto    - new positions of news
     * @param selectedPublishDate - selected date for which we update news position
     * @return
     */
    ...
    public ModelAndView createNewNews(HttpServletRequest request, @Valid @ModelAttribute(NewsItemDto.NEWS_ITEM_DTO) NewsItemDto newsItemDto, BindingResult bindingResult,
        ...
        LOGGER.debug("input parameters request, newsItemDto, bindingResult, selectedPublishDate: [{}], [{}], [{}], [{}]", new Object[] {request, newsItemDto, bindingResult, selectedPublishDate});
     ...
     *
     * @param request
     * @param messageId           - news id that needs to be edited
     * @param selectedPublishDate - selected date
     * @return
     */
     ...
     *
     * @param request
     * @param newsItemDto         - news to be updated
     * @param bindingResult       - result of binding firm inputs to java objects and validation results
     * @param selectedPublishDate - selected date
     * @param messageId           - news id
     * @return
     */
     ...
     *
     * @param request
     * @param messageId           - id of the news
     * @param selectedPublishDate - selected date
