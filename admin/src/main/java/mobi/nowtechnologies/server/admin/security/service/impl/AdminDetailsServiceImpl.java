...
public class AdminDetailsServiceImpl extends JdbcDaoImpl {
	...
	public UserDetails loadUserByUsername(final String userName) throws UsernameNotFoundException {
		...
		List<AdminUserDetails> adminUserDetailsList = getJdbcTemplate().query(loadUserByUsernamePreparedStatementCreator, loadUserByUsernamePreparedStatementSetter, loadUserByUsernameResultSetExtractor);
		...
		List<GrantedAuthority> grantedAuthorityList = getJdbcTemplate().query(loadAuthoritiesByUsernamePreparedStatementCreator, loadAuthoritiesByUsernamePreparedStatementSetter, loadAuthoritiesByUsernameResultSetExtractor);
