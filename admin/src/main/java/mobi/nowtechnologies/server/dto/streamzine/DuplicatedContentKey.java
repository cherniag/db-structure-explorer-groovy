...
public class DuplicatedContentKey {
    ...
    public boolean equals(Object o) {
        ...
        if (block.getContentType() != that.block.getContentType()) return false;
        if (!block.getKey().equals(that.block.getKey())) return false;
        if (block.getValue() != null ? !block.getValue().equals(that.block.getValue()) : that.block.getValue() != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (block.getValue() != null ? block.getValue().hashCode() : 0);
        return result;
    }
}
