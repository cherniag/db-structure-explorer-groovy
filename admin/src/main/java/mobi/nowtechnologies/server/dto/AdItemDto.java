...
public class AdItemDto {
    ...
    static Map<String, AdActionType> actionTypeMap = ImmutableMap.<String, AdActionType>builder().put("http", URL).put("https", URL).put("news", NEWS).put("portal", PORTAL).build();
    static Map<AdActionType, String> titleMap = ImmutableMap.<AdActionType, String>builder().put(NEWS, "news:").put(PORTAL, "portal:").build();
    private Integer id;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("actionType", actionType).append("action", action).append("message", message).append("activated", activated)
                                        .append("filterDtos", filterDtos).append("imageFileName", imageFileName).append("position", position).append("removeImage", removeImage).toString();
    }
}
