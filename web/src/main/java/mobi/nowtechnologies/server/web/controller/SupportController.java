...
public class SupportController extends CommonController {
    ...
    public ModelAndView sendEmailToSupport(HttpServletRequest request, HttpServletResponse response, @Valid @ModelAttribute(ContactUsDto.NAME) ContactUsDto dto, BindingResult result) {
