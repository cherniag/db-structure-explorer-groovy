...
public class RestorePasswordController extends CommonController {
    ...
    public ModelAndView restoreUserPassword(HttpServletRequest request, @CookieValue(value = CommunityResolverFilter.DEFAULT_COMMUNITY_COOKIE_NAME) String communityRedirectURL,
                                            @Valid @ModelAttribute(EmailDto.EMAIL_DTO) EmailDto emailDto, BindingResult bindingResult) {

        LOGGER.debug("input parameters request, emailDto, communityRedirectURL, bindingResult: [{}], [{}], [{}], [{}]", new Object[] {request, emailDto, communityRedirectURL, bindingResult});
