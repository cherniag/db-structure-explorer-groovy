...
public class AccountController extends CommonController {
	...
	public ModelAndView saveAccountDetails(HttpServletRequest request, HttpServletResponse response,
			@Valid @ModelAttribute(AccountDto.ACCOUNT_DTO) AccountDto accountDto, BindingResult bindingResult) {
		LOGGER.debug("input parameters request [{}]", request);
