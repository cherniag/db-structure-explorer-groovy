...
public class TracksController extends CommonController {
    ...
    public void downloadTrack(HttpServletRequest request, HttpServletResponse response, @ModelAttribute(PurchasedTrackDto.PURCHASED_TRACK_DTO) PurchasedTrackDto purchasedTrackDto,
                              @PathVariable("trackname") String trackname) throws ServiceException, IOException {
