...
<div class="footerContainer">
	<div class="footer fixWidth">
		...
		<div class="copyrightBox floatRight">
			<sec:authorize access="anonymous">
				<s:message code='footer.btn.get.it.now' var="footer_btn_get_it_now" />
				<c:if test="${not empty footer_btn_get_it_now}">
					<div class="bottomNote lightGrey"><s:message code="footer.note.text" /></div>
					<div class="buttonShadow floatRight rad7">
						<div class="buttonBox rad7">
							<div class="buttonContent rad7">
								<a href="signup.html" class="button"><s:message code="footer.btn.get.it.now" /></a>
							</div>
						</div>
					</div>
				</c:if>
