...
<div class="subscription_root_container">
    ...
    <a class="go-premium-button subscribe-button-device go-premium-button-target go-premium-body-ok" onclick="submitForm('subscribe_form_${paymentData.payPalPaymentPolicy.id}');">
