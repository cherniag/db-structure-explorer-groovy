...
<div class="container" style="margin-top: 10px;">
    ...
    <div class="subscription-container">
        ...
        <div class="rel" style="margin:12px 6px; padding:6px 0;">
            <input class="button-white no-margin left pie" title="${pageContext.request.contextPath}/payments.html" type="button" onClick="location.href=this.title" value="<s:message code="pays.page.options.note.oppsms.cansel.button"/>" />
            <input class="button-turquoise no-margin right pie" title="${pageContext.request.contextPath}/payments/oppsms_confirm.html?paymentPolicyId=${paymentPolicyId}" type="button" onClick="location.href=this.title" value="<s:message code="pays.page.options.note.oppsms.ok.button"/>" />
