...
<div class="container">
    <div class="content">
        ...
        <div class="rel" style="margin-top: 20px">
            <input class="button-turquoise" title="${pageContext.request.contextPath}/payments/o2psms_confirm.html?paymentPolicyId=${paymentPolicyId}" type="button" onClick="location.href=this.title" value="<s:message code="pays.page.options.note.o2psms.ok.button"/>" />
            <input class="button-grey" title="${pageContext.request.contextPath}/payments.html" type="button" onClick="location.href=this.title" value="<s:message code="pays.page.options.note.o2psms.cansel.button"/>" />
        </div>
    </div>
</div>