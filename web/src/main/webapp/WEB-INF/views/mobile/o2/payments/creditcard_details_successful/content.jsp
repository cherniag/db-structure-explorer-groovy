...
<div class="container">
	<div class="content">
		...
		<!--button-->
		<div class="rel" >
			<input class="button-turquoise" title="${pageContext.request.contextPath}/account.html" type="button" onClick="location.href=this.title" value="<s:message code='m.pay.cc.dialog.successful.button.inapp' />" />
