    ...
    <div class="subscribe_content_container subscribe_content_container_device">
        <div class="subscribe_header_block subscribe_header_block_device">
            ...
            <div class="subscribe_header_ad_title">
                <div class="mtv_tracks_styled_title mtv_tracks_styled_title_device mtv_tracks_styled_title_device_ios mtv_tracks_styled_title_small_device">
                    <s:message code='subscribe.header.title.1'/>
                </div>
                <br>
                <div class="mtv_tracks_styled_title mtv_tracks_styled_title_device mtv_tracks_styled_title_device_ios mtv_tracks_styled_title_big_device">
