...
<div id="mainContent">
	...
	<div class="container">
		<div class="content">
				<h1><s:message code="pay.cc.preview.form.section.order.summary" /></h1>
				<div class="cardDetails">
					<p><s:message code="offer.pay.cc.preview.form.description" /></p>
					
					<h3><s:message code="offer.pay.cc.preview.form.section.card.details" /></h3>
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.card.type" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.info" /></div>
						<div class="valueCell">${creditCardDto.holderTitle.value} ${creditCardDto.holderFirstname} ${creditCardDto.holderLastname}</div>
						<div class="helper"></div>	
					</div>
					
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.card.number" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.issue.number" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.start.date" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.expire.date" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.security.number" /></div>
					...
					<h3><s:message code="offer.pay.cc.preview.form.section.billing.address" /></h3>
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.firstname" /></div>
						<div class="valueCell">${creditCardDto.holderTitle.value} ${creditCardDto.holderFirstname} ${creditCardDto.holderLastname}</div>
						<div class="helper"></div>	
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.address" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.city" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.postcode" /></div>
					...
					<div class="oneLine">
						<div class="nameCell"><s:message code="offer.pay.cc.form.holder.country" /></div>
				...
				<div class="contentButton formButton rad5 rel" id="actionButtons" >
					<input type="button" class="button" id="creditCardSubscribe" value="<s:message code='offer.pay.cc.form.subscribe' />">
...
<script type="text/javascript">
	$("#creditCardSubscribe").click(function() {
		//var url = "payments/creditcard_details.html";
		var url = "offers/"+$('[name=offerId]').val()+"/payments/creditcard_details.html";
		//var url = "offers/payments/creditcard_details.html";
		$("#actionButtons").hide();
		$("#ajaxLoading").show();
