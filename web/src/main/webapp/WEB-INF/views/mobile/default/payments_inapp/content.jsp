		...
		<div class="setOfButtons">
			<c:forEach var="paymentPolicy" items="${paymentsPage.paymentPolicies}">
				...
				<div class="contentButton formButton rad5 rel" style="display:${to_display}">
					<input class="button" title="payments_inapp/${method_name}.html?paymentPolicyId=${paymentPolicy.id}" type="button" onClick="location.href=this.title" value="<s:message code="pays.select.payby" /> ${method_readable}" />
					<span class="rightButtonArrow">
						&nbsp;
					</span>
				</div>
