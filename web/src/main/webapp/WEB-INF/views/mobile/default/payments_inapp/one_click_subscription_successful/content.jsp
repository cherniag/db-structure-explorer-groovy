...
<div class="container">
	<div class="content">
		...
		<p><s:message code='one.click.subscription.dialog.successful.body' arguments='${paymentType},${paymentDetailsByPaymentDto.paymentPolicyDto.duration},${currencyISO},${paymentDetailsByPaymentDto.paymentPolicyDto.subcost}' /></p>
		<div class="clr"></div>				
