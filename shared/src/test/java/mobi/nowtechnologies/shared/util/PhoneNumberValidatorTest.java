...
/**
 * The class <code>PhoneNumberValidatorTest</code> contains tests for the class <code>{@link PhoneNumberValidator}</code>.
 *
...
public class PhoneNumberValidatorTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PhoneNumberValidatorTest.class.getName());
    ...
    public static Collection dataParameters() {
        return Arrays.asList(new Object[][] {{"+380913008666", true},// Ukraine
    ...
    public void testValidate() {
        ...
        if (expectedValue != isValid) {
            LOGGER.error("Expected value: " + expectedValue + " but test returned " + isValid + " for " + phoneNumber);
        }
