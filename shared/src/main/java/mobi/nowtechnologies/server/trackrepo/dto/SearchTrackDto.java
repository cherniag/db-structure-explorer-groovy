...
public class SearchTrackDto implements SearchTrackCriteria {
    ...
    public String toString() {
        return new ToStringBuilder(this, SHORT_PREFIX_STYLE).append("isrc", isrc).append("artist", artist).append("album", album).append("genre", genre).append("title", title)
                                                            .append("ingestor", ingestor).append("label", label).append("ingestFrom", ingestFrom).append("ingestTo", ingestTo)
                                                            .append("releaseFrom", releaseFrom).append("releaseTo", releaseTo).append("withTerritories", withTerritories).append("withFiles", withFiles)
                                                            .append("territory", territory).append("trackIds", trackIds).append("mediaType", mediaType).append("reportingType", reportingType)
                                                            .toString();
    }
}