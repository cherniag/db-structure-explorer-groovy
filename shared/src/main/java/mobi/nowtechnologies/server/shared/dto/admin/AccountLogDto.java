...
public class AccountLogDto {
    ...
    public String toString() {
        return "AccountLogDto [id=" + id + ", userId=" + userId + ", amount=" + amount + ", amountCurrency=" + amountCurrency + ", balanceAfter=" + balanceAfter + ", transactionType=" +
               transactionType + ", gateway=" + gateway + ", logTimestamp=" + logTimestamp + ", promoCode=" + promoCode + ", relatedMediaId=" + relatedMediaId + ", relatedMediaIsrc=" +
               relatedMediaIsrc + ", relatedPaymentUID=" + relatedPaymentUID + ", internalTxId=" + internalTxId + "]";
    }
