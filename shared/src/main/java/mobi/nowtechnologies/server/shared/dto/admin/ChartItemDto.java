...
public class ChartItemDto {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("chartId", chartId).append("mediaDto", mediaDto).append("info", info).append("position", position).append("prevPosition", prevPosition)
                                        .append("chgPosition", chgPosition).append("channel", channel).append("isrc", isrc).append("publishTime", publishTime).append("locked", locked)
