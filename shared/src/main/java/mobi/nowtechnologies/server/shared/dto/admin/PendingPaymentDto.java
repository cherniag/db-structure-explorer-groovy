...
public class PendingPaymentDto {
    ...
    public String toString() {
        return "PendingPaymentDto [id=" + id + ", internalTxId=" + internalTxId + ", amount=" + amount + ", currencyCode=" + currencyCode + ", date=" + date + ", gateway=" + gateway +
               ", numPsmsRetries=" + numPsmsRetries + "]";
    }
