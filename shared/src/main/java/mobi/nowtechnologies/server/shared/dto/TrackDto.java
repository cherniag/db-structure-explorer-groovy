...
public class TrackDto {
	...
	public String toString() {
		return "TrackDto [id=" + id + ", ingestor=" + ingestor + ", isrc=" + isrc + ", title=" + title + ", artist=" + artist + ", ingestionDate=" + ingestionDate + ", status=" + status
				+ ", coverFileName=" + coverFileName + ", subTitle=" + subTitle + ", productId=" + productId + ", productCode=" + productCode + ", genre=" + genre + ", copyright=" + copyright
				+ ", year=" + year + ", album=" + album + ", info=" + info + ", licensed=" + licensed + ", ingestionUpdateDate=" + ingestionUpdateDate + ", publishDate=" + publishDate
				+ ", publishTitle=" + publishTitle + ", publishArtist=" + publishArtist + ", itunesUrl=" + itunesUrl + ", resolution=" + resolution + ", territories=" + territories + ", files="
				+ files + "]";
	}
}