...
public class PurchasedTrackDto {
	...
	public String toString() {
		return "PurchasedTrackDto [artistName=" + artistName + ", isDownloadedOriginal=" + isDownloadedOriginal + ", mediaId=" + mediaId + ", mediaIsrc=" + mediaIsrc
				+ ", purchasedDate=" + purchasedDate + ", trackName=" + trackName + "]";
	}
