...
public class UserRegInfo {
	...
	public String toString() {
		return "UserRegInfo [email=" + email + ", deviceType=" + deviceType
				+ ", deviceString=" + deviceString + ", appVersion="
				+ appVersion + ", communityName=" + communityName
				+ ", operator=" + operator + ", ipAddress=" + ipAddress + "]";
	}
		...
		private CardType(String constantName, int order) {
			if (order < 0)
				throw new IllegalArgumentException(
						"The parameter order is less than zero");
			if (constantName == null)
				throw new NullPointerException(
						"The parameter constantName is null");
	...
	public String getConfEmail() {
		return  confEmail!=null?confEmail.trim():null;
	}
