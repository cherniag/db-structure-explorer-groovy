...
/**
 * <p>All calls to the Media API Wrapper can throw a BrightcoveException.  Most should
 *    throw a subclassed version with specific information (e.g. a wrapper-specific
 *    exception will throw a WrapperException).</p>
 * 
...
public class BrightcoveException extends Exception {
	...
	/**
	 * <p>Creates a generic exception with type UNKNOWN_TYPE.</p>
	 */
	...
	/**
	 * <p>Creates an exception of type JAVA_EXCEPTION.  This will operate
	 *    the same as a java.lang.Exception.</p>
	 * 
	...
	/**
	 * <p>Gets the type of exception.  Different methods may be available
	 *    depending on the type of exception thrown.</p>
	 * 
