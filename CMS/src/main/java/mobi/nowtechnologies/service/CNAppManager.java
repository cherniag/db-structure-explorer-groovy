...
public final class CNAppManager extends IAppManager implements Serializable {
	...
	private static Log LOG = LogFactory.getLog(CNAppManager.class);

	private final String unit;

	private final EntityManagerFactory cnEntityMgrfactory;

	public CNAppManager(String unit_name) {
		unit = unit_name;
		Map<String, Object> configOverrides = new HashMap<String, Object>();
		configOverrides.put("hibernate.connection.url", Property.getInstance().getStringValue("CN.connection.url"));
		configOverrides.put("hibernate.connection.username", Property.getInstance().getStringValue("CN.connection.username"));
		configOverrides.put("hibernate.connection.password", Property.getInstance().getStringValue("CN.connection.password"));
		cnEntityMgrfactory = Persistence.createEntityManagerFactory(unit_name, configOverrides);
	}
	...
	protected EntityManager getEntityManager() {
		...
		if (ret == null) {
			...
			ret = cnEntityMgrfactory.createEntityManager();
