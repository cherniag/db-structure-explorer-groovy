...
public final class AppManager extends IAppManager implements Serializable {
	...
	private final EntityManagerFactory cmsEntityMgrfactory;

	public AppManager(String unit_name) {
		unit = unit_name;
		Map<String, Object> configOverrides = new HashMap<String, Object>();
		configOverrides.put("hibernate.connection.url", Property.getInstance().getStringValue("CMS.connection.url"));
		configOverrides.put("hibernate.connection.username", Property.getInstance().getStringValue("CMS.connection.username"));
		configOverrides.put("hibernate.connection.password", Property.getInstance().getStringValue("CMS.connection.password"));
		cmsEntityMgrfactory = Persistence.createEntityManagerFactory(unit_name, configOverrides);
	}
	...
	protected EntityManager getEntityManager() {
		...
		if (ret == null) {
			...
			ret = cmsEntityMgrfactory.createEntityManager();
