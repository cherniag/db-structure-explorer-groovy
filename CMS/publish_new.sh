...
# Add temporary UITS header to the MP3
	java -cp ${CP}/UITS.jar:${CP}/bcprov-jdk16-146.jar  mobi.nowtechnologies.UITS ${CP}/UITS/key.der "./files/purchased/${ISRC}.mp3" "./${ISRC}.mp3"    || { echo "command failed"; exit 1; } 
...
echo "***** Generating Mobile Audio *****"
	...
	java -cp ${CP}/UITS.jar:${CP}/bcprov-jdk16-146.jar  mobi.nowtechnologies.UITS ${CP}/UITS/key.der ${ISRC}_48.m4a ${ISRC}_48.aud  ${ISRC}_48.hdr|| { echo "command failed"; exit 1; } 
	...
	java -cp ${CP}/UITS.jar:${CP}/bcprov-jdk16-146.jar  mobi.nowtechnologies.UITS ${CP}/UITS/key.der ${ISRC}_96.m4a ${ISRC}_96.aud   ${ISRC}_96.hdr || { echo "command failed"; exit 1; } 
...
#		${FFMPEG} -i "${ISRC}_96.m4a" -y -t 30 -acodec copy "${ISRC}P.m4a"|| { echo "command failed"; exit 1; } 
	...
	java -cp ${CP}/UITS.jar:${CP}/bcprov-jdk16-146.jar  mobi.nowtechnologies.UITS ${CP}/UITS/key.der "${ISRC}P.m4a" ${ISRC}P.aud  ${ISRC}P.hdr || { echo "command failed"; exit 1; } 
