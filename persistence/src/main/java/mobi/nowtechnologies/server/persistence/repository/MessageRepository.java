...
public interface MessageRepository extends JpaRepository<Message, Integer> {
    ...
    @Query("select max(message.publishTimeMillis) from Message message where message.community=:community and message.messageType in (:types) and message.publishTimeMillis>:choosedPublishTimeMillis and message.publishTimeMillis<:currentTimeMillis")
