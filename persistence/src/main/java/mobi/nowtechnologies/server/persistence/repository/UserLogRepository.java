...
public interface UserLogRepository extends JpaRepository<UserLog, Integer> {
    ...
    @Query(value = "select count(userLog) from UserLog userLog " + " where userLog.phoneNumber = ?1 and abs(userLog.logTimeMillis/86400000 - ?3) < 1 and userLog.userLogType = ?2")
