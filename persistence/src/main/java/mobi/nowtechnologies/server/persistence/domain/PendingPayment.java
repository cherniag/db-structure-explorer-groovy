...
@NamedQueries({
	@NamedQuery(name=PendingPayment.NQ_GET_PENDING_PAYMENTS, query="select pp from PendingPayment pp"),
...
public class PendingPayment extends AbstractPayment {
	public static final String NQ_GET_PENDING_PAYMENTS = "NQ_GET_PENDING_PAYMENTS";
