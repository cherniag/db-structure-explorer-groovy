...
public enum BadgeMappingRules {
    WIDE_RULES(ShapeType.WIDE, TypeToSubTypePair.LINK_EXTERNAL_AD, TypeToSubTypePair.LINK_INTERNAL_AD, TypeToSubTypePair.MEDIA_PLAYLIST, TypeToSubTypePair.MEDIA_TRACK),
    NARROW_RULES(ShapeType.NARROW, TypeToSubTypePair.LINK_EXTERNAL_AD, TypeToSubTypePair.LINK_INTERNAL_AD, TypeToSubTypePair.MEDIA_PLAYLIST, TypeToSubTypePair.MEDIA_TRACK);
