...
insert into client_version_messages(id, message_key, url) values(@last_id_1, 'service.config.mtv.tracks.CURRENT.IOS.0.1.0', null);
...
insert into client_version_info (device_type_id, community_id, major_number, minor_number, revision_number, qualifier, message_id, status,         application_name)
                         values ( @ios,         @community_id, 0,            1,            0,               null,     @last_id_1, 'CURRENT',       'mtv-tracks'),
