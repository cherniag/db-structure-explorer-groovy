insert into system (release_time_millis, version, release_name) values(unix_timestamp(), "5.13.2", "5.13.2");

-- SRV-522 - [JADMIN] Restrict playlist Title and subtitle length to 255 characters.
ALTER TABLE tb_chartDetail CHANGE COLUMN title title VARCHAR(255) DEFAULT NULL, CHANGE COLUMN  subtitle subtitle VARCHAR(255) DEFAULT NULL;
