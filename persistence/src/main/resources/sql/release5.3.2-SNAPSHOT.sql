...
where ug.community = tc.id and tc.rewriteURLParameter='o2'), 'PromoCode', 0, 'o2.promo.4weeks.audio', false);
INSERT INTO tb_promoCode (code, promotionId, media_type)
VALUES ('o2.promo.4weeks.audio', 53, 'AUDIO');
...
where ug.community = tc.id and tc.rewriteURLParameter='o2'), 'PromoCode', 0, 'o2.consumer.4g.paym.direct.4weeks.video', false);
INSERT INTO tb_promoCode (code, promotionId, media_type)
VALUES ('o2.consumer.4g.paym.direct.4weeks.video', 54, 'VIDEO_AND_AUDIO');
...
where ug.community = tc.id and tc.rewriteURLParameter='o2'), 'PromoCode', 0, 'o2.consumer.4g.paym.indirect.4weeks.video', false);
INSERT INTO tb_promoCode (code, promotionId, media_type)
VALUES ('o2.consumer.4g.paym.indirect.4weeks.video', 55, 'VIDEO_AND_AUDIO');
...
where ug.community = tc.id and tc.rewriteURLParameter='o2'), 'PromoCode', 0, 'o2.consumer.4g.payg.4weeks.video', false);
INSERT INTO tb_promoCode (code, promotionId, media_type)
VALUES ('o2.consumer.4g.payg.4weeks.video', 56, 'VIDEO_AND_AUDIO');
