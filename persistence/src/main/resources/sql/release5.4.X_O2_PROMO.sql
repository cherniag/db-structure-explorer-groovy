...
(59, 'o2Campaign3G'      , 0       , 0       , 1356342064, 1606780800, true    , 1        , 0       , 10       , 'PromoCode', false        , 'o2Campaign3G'         , false);
...
INSERT INTO tb_promotions
(i , description         , numUsers, maxUsers, startDate , endDate   , isActive, freeWeeks, subWeeks, userGroup, type       , showPromotion, label                  , is_white_listed) VALUES
(60, 'o2Campaign4G'      , 0       , 0       , 1356342064, 1606780800, true    , 1        , 0       , 10       , 'PromoCode', false        , 'o2Campaign4G'         , false);
