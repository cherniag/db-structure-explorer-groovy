...
((SELECT i FROM tb_charts WHERE name = 'HOT_TRACKS - MTVNZ')      , 0       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HOT_TRACKS - MTVNZ'      , 'HOT_TRACKS - MTVNZ'      , 'HOT_TRACKS - MTVNZ'      , NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'FIFTH_CHART - MTVNZ')     , 1       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'FIFTH_CHART - MTVNZ'     , 'FIFTH_CHART - MTVNZ'     , 'FIFTH_CHART - MTVNZ'     , NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'HL_UK_PLAYLIST_1 - MTVNZ'), 2       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HL_UK_PLAYLIST_1 - MTVNZ', 'HL_UK_PLAYLIST_1 - MTVNZ', 'HL_UK_PLAYLIST_1 - MTVNZ', NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'HL_UK_PLAYLIST_2 - MTVNZ'), 3       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HL_UK_PLAYLIST_2 - MTVNZ', 'HL_UK_PLAYLIST_2 - MTVNZ', 'HL_UK_PLAYLIST_2 - MTVNZ', NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'HL_UK_PLAYLIST_3 - MTVNZ'), 4       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HL_UK_PLAYLIST_3 - MTVNZ', 'HL_UK_PLAYLIST_3 - MTVNZ', 'HL_UK_PLAYLIST_3 - MTVNZ', NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'OTHER_CHART - MTVNZ')     , 5       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'OTHER_CHART - MTVNZ'     , 'OTHER_CHART - MTVNZ'     , 'OTHER_CHART - MTVNZ'     , NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'HL_UK_PLAYLIST_4 - MTVNZ'), 6       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HL_UK_PLAYLIST_4 - MTVNZ', 'HL_UK_PLAYLIST_4 - MTVNZ', 'HL_UK_PLAYLIST_4 - MTVNZ', NULL  , NULL),
((SELECT i FROM tb_charts WHERE name = 'HL_UK_PLAYLIST_5 - MTVNZ'), 7       , NULL , NULL        , NULL       , NULL   , NULL, UNIX_TIMESTAMP()*1000, 1      , NULL          , 'HL_UK_PLAYLIST_5 - MTVNZ', 'HL_UK_PLAYLIST_5 - MTVNZ', 'HL_UK_PLAYLIST_5 - MTVNZ', NULL  , NULL);
