...
INSERT INTO tb_charts (name, numTracks, genre, timestamp, numBonusTracks, type) VALUES
  ('FOURTH_CHART FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'FOURTH_CHART'),
  ('HOT_TRACKS FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'HOT_TRACKS'),
  ('FIFTH_CHART FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'FIFTH_CHART'),
  ('HL_UK_PLAYLIST_1 FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'HL_UK_PLAYLIST_1'),
  ('HL_UK_PLAYLIST_2 FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'HL_UK_PLAYLIST_2'),
  ('OTHER_CHART FOR D6', 0, 1, UNIX_TIMESTAMP(now()), 0, 'OTHER_CHART');
