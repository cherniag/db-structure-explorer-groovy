...
ALTER TABLE tb_paymentpolicy ADD advanced_payment_seconds BIGINT UNSIGNED NOT NULL;
ALTER TABLE tb_paymentpolicy ADD after_next_sub_payment_seconds BIGINT UNSIGNED NOT NULL;
