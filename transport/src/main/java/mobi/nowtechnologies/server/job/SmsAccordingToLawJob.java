...
public class SmsAccordingToLawJob extends StatefulMethodInvokingJob {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        try {
            ...
            final String amountOfMoneyToUserNotificationString = messageSource.getMessage(communityURL, "amountOfMoneyToUserNotification", null, null);
            ...
            final String deltaSuccesfullPaymentSmsSendingTimestampMillisString = messageSource.getMessage(communityURL, "deltaSuccesfullPaymentSmsSendingTimestampMillis", null, null);
    ...
    private void proccess(Community community, User user, final MigPaymentDetails currentActivePaymentDetails, final String messageToSearch) {
        ...
        LOGGER.debug("input parameters upperCaseCommunityName, community, user, currentActivePaymentDetails, paymentPolicy, messageCode: [{}], [{}], {{}}, [{}], [{}]", community, user,
                     currentActivePaymentDetails, paymentPolicy, messageToSearch);
        try {
