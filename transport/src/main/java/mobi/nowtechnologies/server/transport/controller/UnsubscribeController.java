...
public class UnsubscribeController extends CommonController {
    ...
    @RequestMapping(method = RequestMethod.POST,
                    value = {"/{community:.+}/{apiVersion:6\\.9}/stop_subscription", "/{community:.+}/{apiVersion:6\\.8}/stop_subscription", "/{community:.+}/{apiVersion:6\\.7}/stop_subscription",
                        ...
                        "/{community:.+}/{apiVersion:4\\.1}/stop_subscription", "/{community:.+}/{apiVersion:4\\.0}/stop_subscription",
                        ...
                        "/{community:.+}/{apiVersion:[3-9]\\.[8-9]\\.[1-9][0-9]{0,2}}/stop_subscription", "/{community:.+}/{apiVersion:[1-9][0-9]\\.[1-9][0-9]}/stop_subscription", "/{community:" +
                                                                                                                                                                                    ".+}/{apiVersion:[1-9][0-9]\\.[0-9]}/stop_subscription", "/{community:.+}/{apiVersion:[3-9]\\.[1-9][0-9]}/stop_subscription", "/{community:.+}/{apiVersion:[3-9]\\.[8-9]}/stop_subscription"})
    public
    @ResponseBody
