...
public class SignInEmailController extends CommonController {
    ...
    @RequestMapping(method = RequestMethod.POST,
                    value = {"**/{community}/{apiVersion:6\\.12}/SIGN_IN_EMAIL", "**/{community}/{apiVersion:6\\.11}/SIGN_IN_EMAIL",
                             "**/{community}/{apiVersion:6\\.10}/SIGN_IN_EMAIL", "**/{community}/{apiVersion:6\\.9}/SIGN_IN_EMAIL",
