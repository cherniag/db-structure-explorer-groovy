...
public class ReferralController extends CommonController {
    ...
    @RequestMapping(method = POST,
                    value = {"**/{community}/{apiVersion:6\\.12}/REFERRALS", "**/{community}/{apiVersion:6\\.11}/REFERRALS", "**/{community}/{apiVersion:6\\.10}/REFERRALS",
                             "**/{community}/{apiVersion:6\\.9}/REFERRALS", "**/{community}/{apiVersion:6\\.8}/REFERRALS", "**/{community}/{apiVersion:6\\.7}/REFERRALS"})
