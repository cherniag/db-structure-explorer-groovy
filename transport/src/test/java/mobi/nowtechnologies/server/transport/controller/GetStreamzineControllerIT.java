...
public class GetStreamzineControllerIT extends AbstractControllerTestIT {
    ...
    public void testGetStreamzineForAnyMQUser_Success() throws Exception {
        ...
        prepareUpdate(updateDate, externalLink, publishDate, newsMessage, chartDetailsId, existingMedia, badgeUrl, community, user);
    ...
    public void testGetStreamzineForSpecificMQUser_Success() throws Exception {
        ...
        prepareUpdate(updateDateForSpecificUser, externalLink, publishDate, newsMessage, chartDetailsId, existingMedia, badgeUrl, community, user);
    ...
    public void testGetStreamzineForSeveralMQUsers_Success() throws Exception {
        ...
        prepareUpdate(updateDatePast, externalLink, publishDate, newsMessage, chartDetailsId, existingMedia, badgeUrl, community, user1, user2);
        prepareUpdate(updateDateFuture, externalLink, publishDate, newsMessage, chartDetailsId, existingMedia, badgeUrl, community, user1, user2);
    ...
    private void prepareUpdate(Date updateDate, String externalLink, Date publishDate, Message newsMessage, int chartDetailsId, Media track, String badgeUrl, Community community, User... users) {
        Update update = streamzineUpdateService.create(updateDate, community);

        // simulate adding blocks
        Update incomingWithBlocks = createWithBlocks(externalLink, publishDate, newsMessage, chartDetailsId, track, badgeUrl, community, users);
        streamzineUpdateService.update(update.getId(), incomingWithBlocks);
    }

    private Update createWithBlocks(String externalLink, Date publishDate, Message newsMessage, int chartDetailsId, Media track, String badgeUrl, Community community, User... users) {
        ...
        //
        u.addBlock(newBlock(7, ShapeType.SLIM_BANNER, createMusicPlaylistDeeplink(chartDetailsId), badgeUrl));
